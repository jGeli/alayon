...
const Map1 = ({ navigation, route }) => {
  ...
  useEffect(() => {
    ...
    socket.on('liveTrack', (liveData) => {
      console.log("TRACK RCV", liveData, riderLoc)
      // Alert.alert('TRACKING NOW!', JSON.stringify(liveData))
  ...
  console.log(riderLoc, 'RIDER LOCAA')
  ...
  function renderHeaderButtons() {
    return (
      <>
        ...
        >
          <TouchableOpacity
            onPress={() => navigation.push('TestScreen', {orderId: order._id})}
            style={{
              width: 40,
              height: 40,
              borderRadius: SIZES.padding,
